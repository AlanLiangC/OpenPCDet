...
from pcdet.utils import common_utils, cal_flops



def parse_config():
    parser = argparse.ArgumentParser(description='arg parser')
    parser.add_argument('--cfg_file', type=str, default='./cfgs/kitti_models/gaus_bridge_vn.yaml',
...
def main():
    ...
    flops, params = cal_flops.get_model_complexity_info(model, input_shape, input_dict=data_dict, input_constructor=input_constructor)
