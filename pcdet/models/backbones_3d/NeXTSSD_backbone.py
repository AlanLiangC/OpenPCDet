...
from ...ops.pointnet2.pointnet2_batch import pointnet2_modules, ALpointnet2_modules
import os

class NeXTSSD_Backbone(nn.Module):
    """ Backbone for IA-SSD"""
        ...
        for k in range(sa_config.NSAMPLE_LIST.__len__()):
            ...
            if self.layer_types[k] == 'SA_Layer':
                ...
                for idx in range(mlps.__len__()):
                    if sa_config.MLP_LOCAL_GROUPER[k]:
                        mlps[idx] = [2*channel_in] + mlps[idx]
                    else:
                ...
                self.SA_modules.append(
                    ALpointnet2_modules.PointMLPSAModuleMSG_WithSampling(
                        ...
                        mlp_local_grouper=sa_config.MLP_LOCAL_GROUPER[k],
    ...
    def forward(self, batch_dict):
        ...
        for i in range(len(self.SA_modules)):
            ...
            if torch.isnan(li_features).sum() > 0:
                print(i)
